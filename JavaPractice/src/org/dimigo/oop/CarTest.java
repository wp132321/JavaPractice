...
public class CarTest {
	...
	public static void main(String[] args) {
		...
		genesis_3 = new Car3("현대자동차", "제네시스", "검정색", 225, 50000000);
		k7_3 = new Car3("기아자동차", "k7", "흰색", 246);
		sm7_3 = new Car3("삼성자동차", "sm7", "흰색");
		...
		System.out.println("<< 자동차 목록 >>");
		System.out.println(String.format("제조사명 : %s\n모델명 : %s\n색상 : %s\n최대속도 : %dkm\n가격 : %,d원\n", genesis_2.getCompany(), genesis_2.getCompany(), genesis_2.getColor(), genesis_2.getMaxSpeed(), genesis_2.getPrice()));
		...
		System.out.println("<< 자동차 목록 >>");
		System.out.println(String.format("제조사명 : %s\n모델명 : %s\n색상 : %s\n최대속도 : %dkm\n가격 : %,d원\n", genesis_3.getCompany(), genesis_3.getCompany(), genesis_3.getColor(), genesis_3.getMaxSpeed(), genesis_3.getPrice()));
		System.out.println(String.format("제조사명 : %s\n모델명 : %s\n색상 : %s\n최대속도 : %dkm\n가격 : %,d원\n", k7_3.getCompany(), k7_3.getCompany(), k7_3.getColor(), k7_3.getMaxSpeed(), k7_3.getPrice()));
		System.out.println(String.format("제조사명 : %s\n모델명 : %s\n색상 : %s\n최대속도 : %dkm\n가격 : %,d원\n", sm7_3.getCompany(), sm7_3.getCompany(), sm7_3.getColor(), sm7_3.getMaxSpeed(), sm7_3.getPrice()));
	}
